...
// Ported verbatim from the original core/artistic-themes.js — procedural MapLibre color palettes.
export const artisticThemes: Record<string, ArtisticTheme> = {
	ancient_woodland: {
	...
	vintage_parchment: {
		...
		description: "Antique sepia parchment paper texture with dark brown ink lines",
		bg: "#F4ECD8",
		text: "#3E2723",
		water: "#D7CCC8",
		parks: "#E8D8C8",
		road_motorway: "#8D6E63",
		road_primary: "#A1887F",
		road_secondary: "#BCAAA4",
		road_tertiary: "#D7CCC8",
		road_residential: "#EFEBE9",
		road_default: "#A1887F",
		route: "#D32F2F"
	},
	architectural_blueprint: {
		name: "Architectural Blueprint",
		description: "Cyan drafting background with crisp white vector road lines",
		bg: "#003366",
		text: "#FFFFFF",
		water: "#002244",
		parks: "#004080",
		...
		road_primary: "#E0F2FE",
		road_secondary: "#BAE6FD",
		road_tertiary: "#7DD3FC",
		road_residential: "#38BDF8",
		road_default: "#BAE6FD",
		route: "#FFD700"
	},
	arctic_frost: {
