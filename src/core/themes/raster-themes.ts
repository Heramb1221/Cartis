import type { RasterTheme } from '../../types/themes';

// Ported verbatim from the original core/themes.js — raster tile providers for Leaflet.
export const themes: Record<string, RasterTheme> = {
	standard: {
		name: "Classic Street",
